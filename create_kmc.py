...
class K_Means:
    def __init__(self, k=2, tol=0.001,max_iter=300):
        self.k = k
        self.tol = tol  # the tolerance value
        self.max_iter = max_iter

    def fit(self, data):

        # define a dictionary to hold the centroids
        self.centroids = {}
...
for classificaiton in clf.classifications:
    color = colors[classificaiton]
    for featureset in clf.classifications[classificaiton]:
